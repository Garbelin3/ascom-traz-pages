      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          <div className="space-y-2">
            ...
            <Input value={originAddress} onChange={e => setOriginAddress(e.target.value)} placeholder="Clique no mapa ou digite o endereço" readOnly={!!origin} />
          </div>
          <div className="space-y-2">
            <Label className="flex items-center gap-2">
            ...
            <Input value={destinationAddress} onChange={e => setDestinationAddress(e.target.value)} placeholder="Clique no mapa ou digite o endereço" readOnly={!!destination} />
          </div>
        </div>

        {/* Mapa abaixo dos campos */}
        <LoadScript googleMapsApiKey="AIzaSyBFw0Qbyq9zTFTd-tUY6dO_2oQ2W-HnV5M">
          <GoogleMap mapContainerStyle={mapContainerStyle} center={center} zoom={13} onClick={onMapClick} options={{
          zoomControl: true,
        ...
        <div className="flex gap-2">
          <Button onClick={confirmRoute} disabled={!origin || !destination} className="bg-ascom hover:bg-ascom-dark">
            Confirmar Corrida
          </Button>
