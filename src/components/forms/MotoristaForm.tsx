...
import { Car, User, Phone, MapPin, FileText, Calendar } from 'lucide-react';
...
const motoristaSchema = z.object({
  ...
  placa_veiculo: z.string().min(7, 'Placa deve ter 7 caracteres'),
  cor_veiculo: z.string().min(2, 'Cor do veículo é obrigatória'),
  ano_veiculo: z.number().min(1990, 'Ano deve ser maior que 1990').max(new Date().getFullYear(), 'Ano não pode ser futuro'),
});
...
const MotoristaForm = () => {
  ...
  const { register, handleSubmit, formState: { errors }, setValue, watch } = useForm<MotoristaFormData>({
  ...
  return (
    <Card className="w-full max-w-4xl mx-auto">
      <CardHeader className="text-center">
        ...
        <CardDescription>
          Cadastre-se como motorista para oferecer corridas na plataforma ASCOM
        </CardDescription>
      </CardHeader>
      <CardContent>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  className={errors.modelo_veiculo ? 'border-red-500' : ''}
                />
                {errors.modelo_veiculo && <p className="text-red-500 text-sm mt-1">{errors.modelo_veiculo.message}</p>}
              </div>
              <div>
                ...
                <Input
                  ...
                  className={errors.placa_veiculo ? 'border-red-500' : ''}
                />
                {errors.placa_veiculo && <p className="text-red-500 text-sm mt-1">{errors.placa_veiculo.message}</p>}
              </div>
              <div>
                ...
                <Input
                  ...
                  className={errors.cor_veiculo ? 'border-red-500' : ''}
                />
                {errors.cor_veiculo && <p className="text-red-500 text-sm mt-1">{errors.cor_veiculo.message}</p>}
              </div>
              <div>
                ...
                <Input
                  ...
                  className={errors.ano_veiculo ? 'border-red-500' : ''}
                />
                {errors.ano_veiculo && <p className="text-red-500 text-sm mt-1">{errors.ano_veiculo.message}</p>}
              </div>
            </div>
          </div>
